...
Function EnableSleepTimeoutLaptop {
	if (Detect-Laptop) {
		Write-Output "Enabling sleep mode timeouts for laptop..."
		powercfg /X standby-timeout-dc 15
	} else {
		Write-Output "Enabling sleep mode timeouts for desktop..."
		powercfg /X standby-timeout-dc 0
	}
	powercfg /X standby-timeout-ac 0
}
...
Function UninstallMsftBloat {
	...
	Get-AppxPackage "Microsoft.MSPaint" | Remove-AppxPackage	# OMG: Use paint.net instead (choco install paint.net)
	Get-AppxPackage "Microsoft.NetworkSpeedTest" | Remove-AppxPackage
	Get-AppxPackage "Microsoft.OfficeLens" | Remove-AppxPackage
	# Get-AppxPackage "Microsoft.Office.OneNote" | Remove-AppxPackage	# OMG: OneNote is actually quite useful
	Get-AppxPackage "Microsoft.Office.Sway" | Remove-AppxPackage
	Get-AppxPackage "Microsoft.OneConnect" | Remove-AppxPackage
	Get-AppxPackage "Microsoft.People" | Remove-AppxPackage
	Get-AppxPackage "Microsoft.Print3D" | Remove-AppxPackage
	Get-AppxPackage "Microsoft.Reader" | Remove-AppxPackage
	# Get-AppxPackage "Microsoft.RemoteDesktop" | Remove-AppxPackage	# OMG: need that!
	...
	# Get-AppxPackage "Microsoft.WindowsScan" | Remove-AppxPackage 		# OMG: need that!
	# Get-AppxPackage "Microsoft.WindowsSoundRecorder" | Remove-AppxPackage	# OMG: moderately useful
...
# Wait for key press
Function WaitForKey {
	Write-Output "`nPress any key to continue...`n"
